...
wboot_drdid_rc <- function(nn, n, y, post, D, int.cov, i.weights,
  ...
  reg.treat.coeff.pre.b <- fastglm_fit(int.cov[treat_pre, , drop = FALSE],
                                       y[treat_pre],
                                       gaussian(link = "identity"),
                                       b.weights[treat_pre])$coefficients
  ...
  reg.treat.coeff.post.b <- fastglm_fit(int.cov[treat_post, , drop = FALSE],
                                        y[treat_post],
                                        gaussian(link = "identity"),
                                        b.weights[treat_post])$coefficients

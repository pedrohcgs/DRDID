context("Compare bootstrapped and analytical std errors: RC")
...
test_that("Analytical and bootstrapped std errors are similar: RC", {
  ...
  std_ipw.did_rc2 <- std_ipw_did_rc(dta_long$y,
                                    dta_long$post,
                                    dta_long$d,
                                    dta_long[,5:8], boot = T, nboot = nboot)
  ...
  expect_equal(dr_imp1.did_rc$ATT, dr_imp1.did_rc2$ATT)
  expect_equal(dr_trad1.did_rc$ATT, dr_trad1.did_rc2$ATT)
  ...
  expect_equal(dr_imp.did_rc$se, dr_imp.did_rc2$se, tol = 0.2)
  expect_equal(dr_trad.did_rc$se, dr_trad.did_rc2$se, tol = 0.2)
  expect_equal(std_ipw.did_rc$se, std_ipw.did_rc2$se, tol = 0.2)
  expect_equal(ipw.did_rc$se, ipw.did_rc2$se, tol = 1.8)
  expect_equal(or.did_rc$se, or.did_rc2$se, tol = 0.5)
  expect_equal(dr_imp1.did_rc$se, dr_imp1.did_rc2$se, tol = 0.2)
  expect_equal(dr_trad1.did_rc$se, dr_trad1.did_rc2$se, tol = 0.2)

  # Check if all standard errors are equal
  expect_equal(dr_imp.did_rc$se, dr_imp.did_rc3$se, tol = 0.2)
  expect_equal(dr_trad.did_rc$se, dr_trad.did_rc3$se, tol = 0.2)
  expect_equal(std_ipw.did_rc$se, std_ipw.did_rc3$se, tol = 0.2)
  expect_equal(ipw.did_rc$se, ipw.did_rc3$se, tol = 1.8)
  expect_equal(or.did_rc$se, or.did_rc3$se, tol = 0.5)
  expect_equal(dr_imp1.did_rc$se, dr_imp1.did_rc3$se, tol = 0.2)
  expect_equal(dr_trad1.did_rc$se, dr_trad1.did_rc3$se, tol = 0.2)
})
